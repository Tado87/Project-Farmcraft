...
{
    //bouton
    private GuiButton nomdevotreserveurButton;
    ...
    public void initGui()
    {
        ...
        //bouton
        controlList.add(nomdevotreserveurButton = new GuiButton(6, width / 2 - 0, i + 12 + 12, 98, 20, stringtranslate.translateKey("FarmCraft")));
        //bouton
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            mc.displayGuiScreen(new GuiConnecting(mc, "77.111.198.137", 25565));
        }
    }
