...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addRecipe(new ItemStack(Block.lanterne, 1), new Object[]
                {
                    "###", "#X#", "###", '#', Item.stick, 'X', Block.glowStone
                });
        //Fin Block Lanterne
        //Block Foin
        ...
        //Fin Block Foin
        //Block RedStone
        addRecipe(new ItemStack(Block.blockRedstone, 1), new Object[]
                {
                    "###", "###", "###", '#', Item.redstone
                });
        ...
        addRecipe(new ItemStack(Block.BlockJumpBlock, 1), new Object[]
                {
                    "###", "#X#", "###", '#', Item.slimeBall, 'X', Block.planks
                });
        addRecipe(new ItemStack(Item.slimeBall, 8), new Object[]
                {
                    "#", '#', Block.BlockJumpBlock
                });
        //fin 
        //Craft arraignée
