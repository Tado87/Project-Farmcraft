...
public class Block
{
    ...
    static
    {
        ...
        //Nouveau Block
        BlockSpeedy = new BlockSpeedy(138, 203).setHardness(0.5F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setBlockName("BlockSpeedy");
        blockRedstone = new Block(140, 202, Material.rock).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("blockRedstone");
        BlockJumpBlock = new BlockJumpBlock(141, 107).setHardness(0.5F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setBlockName("BlockJumpBlock");
        lanterne = new BlockLanterne(142, 212, Material.glass) .setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(1.0F).setBlockName("lanterne");
        Foin = new Block(143, 204, Material.wood).setHardness(2.0F).setResistance(5F).setStepSound(soundGrassFootstep).setBlockName("Foin");
