...
class ContainerCreative extends Container
{
    ...
    public ContainerCreative(EntityPlayer par1EntityPlayer)
    {
        ...
        Block ablock[] =
        {
            Block.BlockSpeedy, Block.blockRedstone, Block.BlockJumpBlock, Block.lanterne, Block.Foin, Block.cobblestone, Block.stone, Block.oreDiamond, Block.oreGold, Block.oreIron, Block.oreCoal, Block.oreLapis, Block.oreRedstone, Block.stoneBrick, Block.stoneBrick,
