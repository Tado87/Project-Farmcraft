...
public class BlockSpeedy extends Block
{
  ...
  public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity) {
    ...
    if (meta == 0) entity.motZ *= 1.350000023841858D;
    else if (meta == 1) entity.motX *= 1.350000023841858D;
    if (entity.motZ > 4.0D) entity.motZ = 4.0D;
    if (entity.motX > 4.0D) entity.motX = 4.0D;
    if (entity.motZ < -4.0D) entity.motZ = -4.0D;
    if (entity.motX < -4.0D) entity.motX = -4.0D;
  }
