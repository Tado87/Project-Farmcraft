...
public class Block {
    ...
    //Nouveau Block
    public static final Block BLOCKSPEEDY = (new BlockSpeedy(138, 168)).c(0.5F).a(j).a(1.0F).a("hellsand");
    public static final Block REDSTONE_BLOCK = (new Block(140, 26, Material.STONE)).c(3.0F).b(5.0F).a(h).a("blockRedstone");
    ...
    public static final Block FOIN = (new Block(143, 187, Material.WOOD)).c(2.0F).b(5.0F).a(f).a("Foin");
  //  Fin Nouveau block
