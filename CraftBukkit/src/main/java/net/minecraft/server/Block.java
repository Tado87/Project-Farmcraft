...
public class Block {
    ...
    public static final Block BLOCKSPEEDY = new BlockSpeedy(138, 206).c(0.5F).a(j).a(1.0F).a("hellsand");
    public static final Block REDSTONE_BLOCK = new Block(140, 205, Material.STONE).c(3.0F).b(5.0F).a(h).a("blockRedstone");
    public static final Block BlockJumpBlock = new BlockJumpBlock(141, 107).c(0.5F).a(j).a(1.0F).a("hellsand");
    public static final Block LANTERNE = new BlockLightStone(142, 212, Material.SHATTERABLE).c(0.3F).a(j).a(1.0F).a("Lanterne");
    public static final Block FOIN = new Block(143, 207, Material.WOOD).c(2.0F).b(5.0F).a(f).a("Foin");
